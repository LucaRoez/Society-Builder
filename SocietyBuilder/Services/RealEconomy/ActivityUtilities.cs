...
namespace SocietyBuilder.Services.RealEconomy
{
    public static class ActivityUtilities
    {
        ...
        private static Dictionary<IActivity[], Necessity> SatietyMap = new()
        {
            ...
            { new[] { new Popular() }, new Necessity(12, "Recreation") }, { new IActivity[] { new Centrism(), new Right_Wing(), new Left_Wing(),
                new ThirdForce(), new Relegated()}, new Necessity(13, "Politics") }, { new IActivity[] { new Basis(), new FellingIndustry(), new Sawmill(),
            ...
            { new IActivity[] { new Funding(), new Basis(), new Civil(), new Commercial(), new Criminal(), new Clerkship(), new Assistance(),
